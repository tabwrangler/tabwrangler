...
| `countOfflineTime`    | `false`                   |                                                                  | Whether to count time while the browser is closed toward tabs' timers. When `false`, timers resume where they left off when the browser reopens |
